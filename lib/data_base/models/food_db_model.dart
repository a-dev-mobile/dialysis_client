...
FoodDbModel copyWith({
  ...
  factory FoodDbModel.fromJson(String source) => FoodDbModel.fromMap(json.decode(source) as Map<String, dynamic>);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.id_product, id_product) || other.id_product == id_product) && 
            (identical(other.id_category, id_category) || other.id_category == id_category) && 
            (identical(other.id_source, id_source) || other.id_source == id_source) && 
