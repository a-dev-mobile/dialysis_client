...
class ProductDbModel {  
  ...
  /*
   factory ProductDbModel.init() => ProductDbModel(
        product_id: 0,
        source_id: 0,
        category_id: 0,
        product_name: '',
...
ProductDbModel copyWith({
    ...
    return ProductDbModel(
      ...
      source_abbrev: source_abbrev ?? this.source_abbrev, 
      ...
      b2_vitamin_riboflavin: b2_vitamin_riboflavin ?? this.b2_vitamin_riboflavin, 
      b5_vitamin: b5_vitamin ?? this.b5_vitamin, 
      b6_vitamin_pyridoxine: b6_vitamin_pyridoxine ?? this.b6_vitamin_pyridoxine, 
      b9_vitamin_folates: b9_vitamin_folates ?? this.b9_vitamin_folates, 
      b12_vitamin_cobalamin: b12_vitamin_cobalamin ?? this.b12_vitamin_cobalamin, 
      ...
      saturated_fatty_acids: saturated_fatty_acids ?? this.saturated_fatty_acids, 
      ...
      k_vitamin_phylloquinone: k_vitamin_phylloquinone ?? this.k_vitamin_phylloquinone, 
      ...
      essential_amino_acids: essential_amino_acids ?? this.essential_amino_acids, 
      ...
      phenylalanine_tyrosine: phenylalanine_tyrosine ?? this.phenylalanine_tyrosine, 
      substitutable_amino_acids: substitutable_amino_acids ?? this.substitutable_amino_acids, 
      ...
      omega_3_Docosahexaeno: omega_3_Docosahexaeno ?? this.omega_3_Docosahexaeno, 
      ...
      conjugated_linoleic_acid: conjugated_linoleic_acid ?? this.conjugated_linoleic_acid, 
      omega_3_alpha_linolenic: omega_3_alpha_linolenic ?? this.omega_3_alpha_linolenic, 
      d3_vitamin_cholecalciferol: d3_vitamin_cholecalciferol ?? this.d3_vitamin_cholecalciferol, 
      ...
      trans_isomer_undefined: trans_isomer_undefined ?? this.trans_isomer_undefined, 
      omega_6_gamma_linolenic: omega_6_gamma_linolenic ?? this.omega_6_gamma_linolenic, 
      ...
      omega_6_docosatetraeno: omega_6_docosatetraeno ?? this.omega_6_docosatetraeno, 
      ...
      d2_vitamin_ergocalciferol: d2_vitamin_ergocalciferol ?? this.d2_vitamin_ergocalciferol, 
      omega_6_20_4: omega_6_20_4 ?? this.omega_6_20_4, 
      omega_3_geneico: omega_3_geneico ?? this.omega_3_geneico, 
      phosphorus_protein_ratio: phosphorus_protein_ratio ?? this.phosphorus_protein_ratio, 
  ...
  factory ProductDbModel.fromMap(Map<String, dynamic> map) {
    return ProductDbModel(
      ...
      source_abbrev: map['source_abbrev'] as String, 
      ...
      k_vitamin_phylloquinone: (map['k_vitamin_phylloquinone'] as num?)?.toDouble(), 
      ...
      phenylalanine_tyrosine: (map['phenylalanine_tyrosine'] as num?)?.toDouble(), 
      substitutable_amino_acids: (map['substitutable_amino_acids'] as num?)?.toDouble(), 
      ...
      conjugated_linoleic_acid: (map['conjugated_linoleic_acid'] as num?)?.toDouble(), 
      omega_3_alpha_linolenic: (map['omega_3_alpha_linolenic'] as num?)?.toDouble(), 
      d3_vitamin_cholecalciferol: (map['d3_vitamin_cholecalciferol'] as num?)?.toDouble(), 
      ...
      trans_isomer_undefined: (map['trans_isomer_undefined'] as num?)?.toDouble(), 
      omega_6_gamma_linolenic: (map['omega_6_gamma_linolenic'] as num?)?.toDouble(), 
      ...
      omega_6_docosatetraeno: (map['omega_6_docosatetraeno'] as num?)?.toDouble(), 
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.product_id, product_id) || other.product_id == product_id) && 
            (identical(other.source_id, source_id) || other.source_id == source_id) && 
            (identical(other.category_id, category_id) || other.category_id == category_id) && 
            (identical(other.product_name, product_name) || other.product_name == product_name) && 
            (identical(other.source_name, source_name) || other.source_name == source_name) && 
            (identical(other.source_abbrev, source_abbrev) || other.source_abbrev == source_abbrev) && 
            (identical(other.category_name, category_name) || other.category_name == category_name) && 
            (identical(other.water, water) || other.water == water) && 
            (identical(other.k_potassium, k_potassium) || other.k_potassium == k_potassium) && 
            (identical(other.na_sodium, na_sodium) || other.na_sodium == na_sodium) && 
            (identical(other.p_phosphorus, p_phosphorus) || other.p_phosphorus == p_phosphorus) && 
            (identical(other.ca_calcium, ca_calcium) || other.ca_calcium == ca_calcium) && 
            (identical(other.proteins, proteins) || other.proteins == proteins) && 
            (identical(other.calorie, calorie) || other.calorie == calorie) && 
            (identical(other.carbohydrates, carbohydrates) || other.carbohydrates == carbohydrates) && 
            (identical(other.fats, fats) || other.fats == fats) && 
            (identical(other.feed_ash, feed_ash) || other.feed_ash == feed_ash) && 
            (identical(other.a_vitamin, a_vitamin) || other.a_vitamin == a_vitamin) && 
            (identical(other.retinol, retinol) || other.retinol == retinol) && 
            (identical(other.beta_carotene, beta_carotene) || other.beta_carotene == beta_carotene) && 
            (identical(other.b1_vitamin_thiamine, b1_vitamin_thiamine) || other.b1_vitamin_thiamine == b1_vitamin_thiamine) && 
            (identical(other.b2_vitamin_riboflavin, b2_vitamin_riboflavin) || other.b2_vitamin_riboflavin == b2_vitamin_riboflavin) && 
            (identical(other.b5_vitamin, b5_vitamin) || other.b5_vitamin == b5_vitamin) && 
            (identical(other.b6_vitamin_pyridoxine, b6_vitamin_pyridoxine) || other.b6_vitamin_pyridoxine == b6_vitamin_pyridoxine) && 
            (identical(other.b9_vitamin_folates, b9_vitamin_folates) || other.b9_vitamin_folates == b9_vitamin_folates) && 
            (identical(other.b12_vitamin_cobalamin, b12_vitamin_cobalamin) || other.b12_vitamin_cobalamin == b12_vitamin_cobalamin) && 
            (identical(other.c_vitamin, c_vitamin) || other.c_vitamin == c_vitamin) && 
            (identical(other.e_vitamin, e_vitamin) || other.e_vitamin == e_vitamin) && 
            (identical(other.rr_vitamin, rr_vitamin) || other.rr_vitamin == rr_vitamin) && 
            (identical(other.niacin, niacin) || other.niacin == niacin) && 
            (identical(other.mg_magnesium, mg_magnesium) || other.mg_magnesium == mg_magnesium) && 
            (identical(other.s_sulfur, s_sulfur) || other.s_sulfur == s_sulfur) && 
            (identical(other.cl_chlorine, cl_chlorine) || other.cl_chlorine == cl_chlorine) && 
            (identical(other.fe_iron, fe_iron) || other.fe_iron == fe_iron) && 
            (identical(other.i_iodine, i_iodine) || other.i_iodine == i_iodine) && 
            (identical(other.co_cobalt, co_cobalt) || other.co_cobalt == co_cobalt) && 
            (identical(other.mn_manganese, mn_manganese) || other.mn_manganese == mn_manganese) && 
            (identical(other.cu_copper, cu_copper) || other.cu_copper == cu_copper) && 
            (identical(other.mo_molybdenum, mo_molybdenum) || other.mo_molybdenum == mo_molybdenum) && 
            (identical(other.ni_nickel, ni_nickel) || other.ni_nickel == ni_nickel) && 
            (identical(other.se_selenium, se_selenium) || other.se_selenium == se_selenium) && 
            (identical(other.f_fluorine, f_fluorine) || other.f_fluorine == f_fluorine) && 
            (identical(other.cr_chrome, cr_chrome) || other.cr_chrome == cr_chrome) && 
            (identical(other.zh_zinc, zh_zinc) || other.zh_zinc == zh_zinc) && 
            (identical(other.cholesterol, cholesterol) || other.cholesterol == cholesterol) && 
            (identical(other.saturated_fatty_acids, saturated_fatty_acids) || other.saturated_fatty_acids == saturated_fatty_acids) && 
            (identical(other.myristina, myristina) || other.myristina == myristina) && 
            (identical(other.palmitic, palmitic) || other.palmitic == palmitic) && 
            (identical(other.stearic, stearic) || other.stearic == stearic) && 
            (identical(other.arachinova, arachinova) || other.arachinova == arachinova) && 
            (identical(other.mono_fatty_acids, mono_fatty_acids) || other.mono_fatty_acids == mono_fatty_acids) && 
            (identical(other.palmitoleic, palmitoleic) || other.palmitoleic == palmitoleic) && 
            (identical(other.heptadecene, heptadecene) || other.heptadecene == heptadecene) && 
            (identical(other.omega_9_oleic, omega_9_oleic) || other.omega_9_oleic == omega_9_oleic) && 
            (identical(other.omega_9_gadolein, omega_9_gadolein) || other.omega_9_gadolein == omega_9_gadolein) && 
