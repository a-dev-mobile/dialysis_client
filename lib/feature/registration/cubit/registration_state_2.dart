...
*/
  ...
  /*
   factory RegistrationState2.init() => RegistrationState2(
        heightList: const [],
        ckdSelected: const [],
      ); 
  */
  
RegistrationState2 copyWith({
    bool? isLoadPage,
    bool? isLoadNextPage,
    bool? isValid,
  ...
  factory RegistrationState2.fromMap(Map<String, dynamic> map) {
    return RegistrationState2(
